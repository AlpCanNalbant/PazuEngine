...
namespace Pazu::Math
{
	...
	Matrix::Matrix(const DirectX::XMFLOAT3X3 &M) noexcept
	{
		_11 = M._11;
		_12 = M._12;
		_13 = M._13;
	...
	Matrix::Matrix(const DirectX::XMFLOAT4X3 &M) noexcept
	{
		_11 = M._11;
		_12 = M._12;
		_13 = M._13;
	...
	Matrix::Matrix(DirectX::CXMMATRIX M) noexcept
	{
	...
	Matrix &Matrix::operator=(const DirectX::XMFLOAT3X3 &M) noexcept
	{
		_11 = M._11;
		_12 = M._12;
		_13 = M._13;
	...
	Matrix &Matrix::operator=(const DirectX::XMFLOAT4X3 &M) noexcept
	{
		_11 = M._11;
		_12 = M._12;
		_13 = M._13;
	...
	Matrix Matrix::CreatePerspectiveFieldOfView(float fov, float aspectRatio, float nearPlane, float farPlane) noexcept
	{
		using namespace DirectX;
		Matrix R;
	...
	Matrix Matrix::CreatePerspective(float width, float height, float nearPlane, float farPlane) noexcept
	{
		using namespace DirectX;
		Matrix R;
	...
	Matrix Matrix::CreateOrthographic(float width, float height, float zNearPlane, float zFarPlane) noexcept
	{
		using namespace DirectX;
		Matrix R;
	...
	Matrix Matrix::CreateOrthographicOffCenter(float left, float right, float bottom, float top, float zNearPlane, float zFarPlane) noexcept
	{
		using namespace DirectX;
		Matrix R;
...
namespace std
{
	bool less<Pazu::Math::Matrix>::operator()(const Pazu::Math::Matrix &M1, const Pazu::Math::Matrix &M2) const noexcept
	{
		if (M1._11 != M2._11)
